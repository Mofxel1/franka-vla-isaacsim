#!/bin/bash
# Kapali donguda ALGI ile EYLEMI ayir: modelin kendi kup tahmini adim adim loglanir
...
run ~/franka_runs/train_geo3/checkpoints/006000/pretrained_model geo3algi
log "ALGI OLCUMU HAZIR"
